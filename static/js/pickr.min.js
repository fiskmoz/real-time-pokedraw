  ...
  return (function (t) {
    ...
    function (t, e, o) {
      ...
      function m(t, e = (t) => t) {
        ...
        a(t, "focus", () => a(window, "wheel", o, { passive: !1 })),
        ...
        const e = {
            ...
            destroy() {
              ...
              l(document, ["keydown", "keyup"], n),
                l([t.wrapper, t.element], "mousedown", o),
                l([t.wrapper, t.element], "touchstart", o, { passive: !1 });
            },
          },
          { options: o, _tapstart: n, _keyboard: i } = e;
        return (
          a([o.wrapper, o.element], "mousedown", n),
          a([o.wrapper, o.element], "touchstart", n, { passive: !1 }),
      ...
      function B({ el: t, reference: e, padding: o = 8 }) {
        ...
        return {
          update(s, c = !1) {
            const { position: a, variant: l, isVertical: p } = r(s),
              u = e.getBoundingClientRect(),
              h = t.getBoundingClientRect(),
              d = (t) =>
                t
                  ? { t: u.top - h.height - o, b: u.bottom + o }
                  : { r: u.right + o, l: u.left - h.width - o },
              f = (t) =>
                t
                  ? {
            ...
            c
              ...
              : ((t.style.left = m.left), (t.style.top = m.top));
          },
        };
      }
      function H(t, e, o) {
      ...
      class R {
        constructor(t) {
          ...
          (this._nanopop = B({ reference: u, padding: s, el: h })),
              ...
              a = h(
                '\n      <div :ref="root" class="pickr">\n\n        '
                  ...
                  .concat(
                    ...
                    ' aria-label="color picker dialog" role="form">\n          <div class="pcr-selection" '
                  )
                  .concat(
                    c(t.palette),
                ...
                onchange(o, n) {
                  ...
                  (this.element.style.background = p),
                    (this.wrapper.style.background = "\n                        linear-gradient(to top, rgba(0, 0, 0, "
                      ...
                      .concat(i.a, "))\n                    ")),
                    c.comparison
                      ? c.useAsButton || t._lastColor || (a.style.color = p)
        ...
        destroy() {
          this._eventBindings.forEach((t) => l(...t)),
      ...
      (R.utils = n),
        (R.libs = { HSVaColor: x, Moveable: L, Nanopop: B, Selectable: P }),
        (R.create = (t) => new R(t)),
        (R.version = v.a);
      e.default = R;
    },
